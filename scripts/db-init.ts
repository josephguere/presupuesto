...
const EXPECTED = {
  ...
  constraints: [
    ...
    "category_goals_unique",
    "category_goals_month_check",
    "category_goals_amount_check",
  ],
  indexes: [
    ...
    "transactions_contabilizar_idx",
    "category_goals_period_idx",
