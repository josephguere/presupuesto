...
export function buildIntentSystemInstruction(catalog: Catalog, now: Date = new Date()): string {
  ...
  return [
    ...
    "  monthly_evolution     cómo ha ido el gasto mes a mes: «evolución»,",
    "                        «tendencia», «últimos N meses», «cómo viene»",
    "",
    ...
    "  · meses solo con monthly_evolution, si dijo cuántos («últimos 3 meses»).",
    "    Esa intención mira varios meses por su cuenta: NO le pongas período.",
    "",
